    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/public/v1/licenses/activate",
                                "/public/v1/licenses/validate", "/public/v1/licenses/tokens/rotate").permitAll()
                        .requestMatchers("/public/**").denyAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/licenses/**").hasAuthority("license:read")
                        .requestMatchers("/api/v1/licenses/**").hasAuthority("license:manage")
